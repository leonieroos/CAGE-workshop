...
# 3.5 Heatmaps
Lastly, we can visualize the sequence surrounding the dominant CTSS using density heatmaps. To this end, we'll use the package _heatmaps_. We need similar data to described in 3.3.1 and 3.3.2 but we can extend the window to 400 up and downstream:
